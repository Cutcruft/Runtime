...
import type { BindingContext, Canvas2DConfig, Canvas2DContent, Canvas2DElement, Canvas2DPoint, Canvas2DTool, Canvas2DToolbarButton } from '../protocol/componentSpec'
