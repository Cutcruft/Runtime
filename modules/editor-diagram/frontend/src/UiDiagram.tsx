...
import { cursorStore } from '@cutcrft/plugin-sdk'
...
import type { BindingContext, DiagramConfig, DiagramContent, DiagramEdgeSpec, DiagramNodeSpec, DiagramStencilNodeSpec, DiagramToolbarButton } from '@cutcrft/plugin-sdk'
import './diagram.css'
