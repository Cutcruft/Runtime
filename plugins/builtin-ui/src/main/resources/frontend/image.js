import { defineComponent as r, unref as e, openBlock as o, createElementBlock as i, normalizeStyle as n, normalizeClass as l, toDisplayString as p } from "vue";
...
const _ = ["src", "alt", "title"], g = {
  ...
  setup(a) {
    ...
    return (s, d) => e(t).src && c(e(t).src) ? (o(), i("img", {
      key: 0,
...
}), C = /* @__PURE__ */ f(h, [["__scopeId", "data-v-89a47bc9"]]);
export {
  C as default
};
